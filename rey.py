...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                             ...
                             ki.sendMessage(to, "●➢ NAGA SPEED FULL..")
                             elapsed_time = time.time() - start
                             ki.sendMessage(to,format(str(elapsed_time))) 
                             kk.sendMessage(to, "●➢ NAGA SPEED FULL..")
                             elapsed_time = time.time() - start
                             kk.sendMessage(to,format(str(elapsed_time))) 
                             kc.sendMessage(to, "●➢ NAGA SPEED FULL..")
                             elapsed_time = time.time() - start
                             kc.sendMessage(to,format(str(elapsed_time))) 
                             sw.sendMessage(to, "●➢ NAGA SPEED FULL..")
                             elapsed_time = time.time() - start
                             sw.sendMessage(to,format(str(elapsed_time))) 
