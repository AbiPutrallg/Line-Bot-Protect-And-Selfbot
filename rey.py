...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='Ex2gQmDafcKJuyfrxph2.qr5zqRaj72xYzhhusepz4G.gDxkqp+Nn3S8mkVg59fiXzDbt7mujKQXQ82GTNpeTWg=')
...
#===========BOT UPDATE============#
                        ...
                        if text.lower() == 'sp':
                            ...
                            cl.sendText(to,"════SPEED BOTS═══\n" + "%seconds" % (elapsed_time) + "\n════NAGA MERAH═══")
                            ki.sendText(to,"════SPEED BOTS═══\n" + "%seconds" % (elapsed_time) + "\n════NAGA MERAH═══")
                            kk.sendText(to,"════SPEED BOTS═══\n" + "%seconds" % (elapsed_time) + "\n════NAGA MERAH═══")
                            kc.sendText(to,"════SPEED BOTS═══\n" + "%seconds" % (elapsed_time) + "\n════NAGA MERAH═══")
                            sw.sendText(to,"════SPEED BOTS═══\n" + "%seconds" % (elapsed_time) + "\n════NAGA MERAH═══")
